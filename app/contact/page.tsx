      ...
      <section className="container mx-auto px-6 py-16">
        <Reveal>
          <div className="text-center max-w-3xl mx-auto">
            <p className="text-xs uppercase tracking-[0.6em] text-neon-cyan/80 mb-4">Connect With Us</p>
              ...
              <div className="card border border-white/10 bg-midnight-900/60 backdrop-blur-xl">
                ...
                <div className="space-y-5">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-sm font-semibold uppercase tracking-[0.25em] text-slate-300">Email</h4>
                      <p className="text-slate-400">aacomputerremoteservices@gmail.com</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-sm font-semibold uppercase tracking-[0.25em] text-slate-300">Response Time</h4>
                      <p className="text-slate-400">Typically within a few hours</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-sm font-semibold uppercase tracking-[0.25em] text-slate-300">Service Area</h4>
                      <p className="text-slate-400">100% Remote • Global Coverage</p>
                    </div>
                  </div>
                </div>
              </div>
